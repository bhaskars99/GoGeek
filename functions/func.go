...
func main () {
	...
	//two params
	fmt.Println(nameAge("Bhaskar", 21))
	
	//two returns
	dogYears, old := dogAge ("bhaskar", 21)
	var mySentence string = "bhaskar is " + strconv.Itoa(dogYears) + " in dog years and is "
	if old {
	...
	print("hello world!", "this is bhaskar", "how are you doing today?")
